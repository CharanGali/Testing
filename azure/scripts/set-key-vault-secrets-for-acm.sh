...
./../tools/set-key-vault-secret.sh "acmAccessKeyId" "$ACM_ACCESS_KEY_ID" "$SUBSCRIPTION_CODE" "$KEY_VAULT_NAME"
./../tools/set-key-vault-secret.sh "acmSecretAccessKey" "$ACM_SECRET_ACCESS_KEY" "$SUBSCRIPTION_CODE" "$KEY_VAULT_NAME"
